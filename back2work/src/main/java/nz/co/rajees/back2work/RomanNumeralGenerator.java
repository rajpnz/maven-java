...
public class RomanNumeralGenerator {
	 ...
	 * @param number Build the roman numeral representation for this int
	 * @return a String that is a roman numeral 
	 * @see <a href="http://codingdojo.org/cgi-bin/index.pl?KataRomanNumerals">Roman Numeral Kata</a>
	 */
